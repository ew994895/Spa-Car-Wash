...
│   ├── components/
│   │   ├── layout/              # Header, Footer, BackToTop, CrispChat
│   │   ├── sections/            # Hero, Membership, Contact, etc.
│   │   ├── features/
│   │   │   ├── booking/         # Booking form experience
│   │   │   ├── promotions/      # Promotion widgets + admin
│   │   │   ├── status/          # Business status admin
│   │   │   └── wait-times/      # Wait time badges + admin
│   │   └── ui/                  # Radix-based primitives
│   ├── pages/                   # Home, PremiumDetailing, UltimateDetailing
